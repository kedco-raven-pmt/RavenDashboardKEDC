...
const BCrumb = [
  ...
  {
    title: 'Technical Customer',
  },
];

const TechnicalCustomer = () => {
  return (
    <PageContainer title="Technical Customer" description="this is Charts page">
      {/* breadcrumb */}
      <Breadcrumb title="Technical Customer" items={BCrumb} />
      {/* end breadcrumb */}
...
export default TechnicalCustomer;
