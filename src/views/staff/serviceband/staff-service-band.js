...
const BCrumb = [
  ...
  {
    title: 'Staff Service Band',
  },
];

const StaffServiceBand = () => {
  return (
    <PageContainer title="Staff Service Band" description="this is Charts page">
      {/* breadcrumb */}
      <Breadcrumb title="Staff Service Band" items={BCrumb} />
      {/* end breadcrumb */}
...
export default StaffServiceBand;
