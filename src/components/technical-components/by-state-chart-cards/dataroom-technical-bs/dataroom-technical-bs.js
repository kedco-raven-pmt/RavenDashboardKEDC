...
export const TechnicalDataMapbox = {
    'NG018': {
      ...
      faults: [39000, 40000, 41000, 42000],
      feeders: [180, 185, 190, 195]
    },
    'NG020': {
      name: 'Kano',
      ...
      faults: [40000, 41000, 42000, 43000],
      feeders: [185, 190, 195, 200]
    },
    'NG021': {
      name: 'Katsina',
      ...
      faults: [42000, 43000, 44000, 45000],
      feeders: [190, 195, 200, 205]
    }
  };
