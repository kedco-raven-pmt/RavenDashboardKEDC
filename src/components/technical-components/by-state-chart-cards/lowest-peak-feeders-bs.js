...
const LowestPeakFeedersBS = () => {
  ...
  const lowpeakfeederscolumnchart = {
    ...
    colors: ['#5bbea9', '#74d2bb', '#8cd9c4', '#a6e2d4', '#bfeae7'],
    plotOptions: {
      bar: {
        borderRadius: 3,
        columnWidth: '60%',
  ...
  return (
    <DashboardCard title="Lowest 5 Peak Loaded Feeders">
      <>
        <Chart
          options={lowpeakfeederscolumnchart}
          series={lowpeakfeedersseries}
          type="bar"
          height="280px"
        />
      </>
...
export default LowestPeakFeedersBS;
