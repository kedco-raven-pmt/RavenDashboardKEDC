...
const HighestPeakFeedersBBD = () => {
    ...
    return (
        <DashboardCard
            title="Top 5 Peak Loaded Feeders" 
        >
            <>
                <Chart options={topfeederscolumnchart} series={topfeedersseries} type="bar" height="280px" />
            </>
...
export default HighestPeakFeedersBBD;
