...
const BusinessDistrictFilterTechnicalBBD = ({ onFilterChange, selectedState, selectedBusinessDistrict }) => {
...
BusinessDistrictFilterTechnicalBBD.propTypes = {
  onFilterChange: PropTypes.func.isRequired,
  selectedState: PropTypes.string.isRequired,
  selectedBusinessDistrict: PropTypes.string.isRequired,
};

export default BusinessDistrictFilterTechnicalBBD;
