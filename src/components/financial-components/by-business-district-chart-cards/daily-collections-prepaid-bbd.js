...
const DailyCollectionPrePaidBBD = ({ selectedBusinessDistrict }) => {
  ...
  const dailyPrePaidCollections = district ? district.dailyPrePaidCollections : aggregateCollections('prepaid');
...
export default DailyCollectionPrePaidBBD;
