...
const BusinessDistrictFilterFinancialBBD = ({ onFilterChange, selectedState, selectedBusinessDistrict }) => {
  ...
  const handleBusinessDistrictButtonClick = (businessDistrict) => {
    ...
    onFilterChange(newSelectedBusinessDistrict);
...
BusinessDistrictFilterFinancialBBD.propTypes = {
  onFilterChange: PropTypes.func.isRequired,
  selectedState: PropTypes.string.isRequired,
  selectedBusinessDistrict: PropTypes.string.isRequired,
};

export default BusinessDistrictFilterFinancialBBD;
