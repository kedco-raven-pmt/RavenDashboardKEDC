...
const DailyCollectionPrePaidBS = ({ selectedState }) => {
  ...
  const dailyPrePaidCollections = state ? state.dailyPrePaidCollections : aggregateCollections('prepaid');
...
export default DailyCollectionPrePaidBS;
