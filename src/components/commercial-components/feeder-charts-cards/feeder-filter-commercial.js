...
const FeederFilterCommercial = ({ onFilterChange, selectedState, selectedBusinessDistrict }) => {
...
FeederFilterCommercial.propTypes = {
  onFilterChange: PropTypes.func.isRequired,
  selectedState: PropTypes.string,
  selectedBusinessDistrict: PropTypes.string,
};

export default FeederFilterCommercial;
