...
const ATCCCommercialSBT = () => {
  ...
  const SBTChartOptions = {
    ...
    xaxis: {
      categories: [['Billing Efficiency'], ['Collection Efficiency'], ['Energy Collected']],
              ...
              <Stack direction="row" alignItems="center" spacing={1} key={index}>
                ...
                <Box>
                  <Typography variant="subtitle2" fontSize="12px" fontWeight={700} color="textSecondary">
                    {['Billing Efficiency', 'Collection Efficiency', 'ATC&C', 'Customer Response Rate'][index]}
                  </Typography>
                </Box>
              </Stack>
            ))}
            ...
            <Grid item xs={12} sm={2.4} key={index}>
              <BlankCard>
                ...
                <Box justifyContent="center" textAlign="right">
                  <Tooltip title="Customer Response Rate">
...
export default ATCCCommercialSBT;
