          ...
          <Grid item sm={6} display="flex" alignItems="center">
            ...
            <Typography gap="16px" mb={10} variant="h4" whiteSpace="nowrap">
              ...
              >
                ...
                <Typography variant="h5" whiteSpace="nowrap">Commercial Overview:</Typography>
              </Box>
              ...
              <Stack spacing={2}  direction="row" divider={<Divider orientation="vertical" flexItem />}>
                ...
                <Typography variant="subtitle1" whiteSpace="nowrap">Total Collection</Typography>
                </Box>
                <Box>
                <Typography variant="h2" whiteSpace="nowrap">35%<span><IconArrowUpRight width={18} color="#39B69A" /></span></Typography>
                <Typography variant="subtitle1" whiteSpace="nowrap">Collection Efficiency</Typography>
                </Box>
                <Box>
                <Typography variant="h2" whiteSpace="nowrap">20%<span><IconArrowDownLeft width={18} color="#b63939" /></span></Typography>
                <Typography variant="subtitle1" whiteSpace="nowrap">ATC&C</Typography>
                </Box>
              </Stack>
            </Box>
          </Grid>
