...
import icon2 from '../../../assets/images/svgs/icon-collections.svg';

const CollectionsWidgetOverview = () => {
  // chart color
      ...
      <CardContent sx={{ p: '25px' }}>
        ...
        <Grid container spacing={3} mt={2}>
          <Grid item xs={5} sx={{ paddingRight: '10px' }}>
            <Typography variant="h4" mt={3} fontWeight={600}>₦46bn</Typography>
...
export default CollectionsWidgetOverview;