...
import icon2 from '../../../assets/images/svgs/icon-DurationofInterruption.svg';

const DurationofInterruptionWidgetOverview = () => {
  // chart color
  ...
  const seriescolumnchart = [
    {
      ...
      data: [5, 6, 4, 6], // Example data for the past 4 months
    },
  ];
    ...
    <BlankCard>
      <CardContent sx={{ p: '25px' }}>
        <Stack direction="row" spacing={2} alignItems="center">
          ...
          <Typography variant="h5">Duration of Interruption</Typography>
        </Stack>

        <Grid container spacing={3} mt={2}>
          <Grid item xs={5} sx={{ paddingRight: '10px' }}>
            <Typography variant="h4" mt={3} fontWeight={600}>6 Hrs</Typography>
...
export default DurationofInterruptionWidgetOverview;