...
const ATCCWidgetOverview = () => {
  ...
  const seriescolumnchart = [
    {
      name: 'ATCC',
      data: [56, 71, 63, 59], // Example data for the past 4 months
    },
  ];
      ...
      <CardContent sx={{ p: '25px' }}>
        ...
        <Grid container spacing={3} mt={2}>
          <Grid item xs={5} sx={{ paddingRight: '10px' }}>
            <Typography variant="h4" mt={3} fontWeight={600}>59%</Typography>
...
export default ATCCWidgetOverview;